...
output_file="${data_type}_clustering.pdf"
...
gnuplot <<EOF
    ...
    plot "${input_file}" every ::1::5 using (\$3/1000) title "CFNAgg-clu" with histogram, \
         "${input_file}" every ::1::5 using (\$2/1000) title "Baseline-clu" with histogram,
